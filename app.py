        ...
        if usuario_token:
            try:
                ...
                if user:
                    ...
                    st.session_state["permissoes"] = {
                        "pode_ver_saving": user[2], "pode_importar_saving": user[3],
                        "pode_gerenciar_budgets": user[4], "pode_consultar_estoque": user[5],
                        "pode_dar_entrada_estoque": user[6], "pode_dar_baixa_estoque": user[7],
                        "pode_enderecar_estoque": user[8], "pode_transferir_estoque": user[9],
                        "pode_estornar_estoque": user[10], "e_admin": user[11]
                    }
            except Exception:
                pass
            ...
            if usuario_input and senha_input:
                try:
                    ...
                    if user and user[2] == senha_input:
                        ...
                        st.session_state["perfil"] = user[1]
                        st.session_state["permissoes"] = {
                            "pode_ver_saving": user[3], "pode_importar_saving": user[4],
                            "pode_gerenciar_budgets": user[5], "pode_consultar_estoque": user[6],
                            "pode_dar_entrada_estoque": user[7], "pode_dar_baixa_estoque": user[8],
                            "pode_enderecar_estoque": user[9], "pode_transferir_estoque": user[10],
                            "pode_estornar_estoque": user[11], "e_admin": user[12]
                        }
